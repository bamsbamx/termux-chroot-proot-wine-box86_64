...
You can set up everything using this command in Termux (Github version):
    ...
    yes | pkg update -y && pkg install -y wget && wget https://raw.githubusercontent.com/bamsbamx/termux-chroot-proot-wine-box86_64/main/Scripts/Getting_Started.sh && chmod +x Getting_Started.sh && ./Getting_Started.sh && rm Getting_Started.sh
